...
function zen_send_html($to, $subject, $html, $fromHeader) {
    $headers   = [];
    $headers[] = 'MIME-Version: 1.0';
    $headers[] = 'Content-Type: text/html; charset=UTF-8';
    $headers[] = 'From: ' . $fromHeader;
    $headers[] = 'Reply-To: ' . MAIL_FROM;
    $headers[] = 'X-Mailer: ZenClinics';
...
if (SEND_CLIENT_CONFIRMATION) {
    ...
    zen_send_html($email, 'Confirmare solicitare Card VIP — ZEN Clinics', $clientHtml, $fromHeader);
}

// Notificare catre echipa
if (NOTIFY_ENABLED) {
    ...
    zen_send_html(NOTIFY_TO, 'Card VIP — înscriere nouă: ' . $displayName, $notifyHtml, $fromHeader);
}
